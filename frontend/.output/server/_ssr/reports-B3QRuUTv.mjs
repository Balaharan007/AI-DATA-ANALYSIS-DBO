...
import { c as endpoints, n as CardContent, o as baseURL, t as Card } from "./card-_vjpV4Yv.mjs";
...
import { F as Eye, G as CircleCheck, K as CircleAlert, P as FileText, R as Download, c as Trash2, p as Send } from "../_libs/lucide-react.mjs";
import { n as toast } from "../_libs/sonner.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/reports-B3QRuUTv.js
				...
				return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Card, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(CardContent, {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: [
							...
							telegramSent && !isSending && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Button, {
								size: "sm",
								variant: "outline",
								className: "w-full",
								onClick: () => sendToTelegram.mutate(r.id),
								children: [
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)(CircleCheck, { className: "mr-1 h-3.5 w-3.5 text-green-600" }),
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "Sent to Telegram" }),
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Send, { className: "ml-1 h-3.5 w-3.5" })
								]
							}),
							!telegramSent && r.url && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Button, {
								...
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Send, { className: `mr-1 h-3.5 w-3.5 ${sendToTelegram.isPending && sendToTelegram.variables === r.id ? "animate-spin" : ""}` }), sendToTelegram.isPending && sendToTelegram.variables === r.id ? "Sending..." : "Send to Telegram"]
							}),
							isSending && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								className: "flex items-center justify-center text-sm text-muted-foreground",
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(CircleAlert, { className: "mr-1 h-3.5 w-3.5 animate-spin text-blue-500" }), "Sending to Telegram..."]
							}),
