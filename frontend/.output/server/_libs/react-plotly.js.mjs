...
import { t as require_plotly } from "./plotly.js.mjs";
//#region node_modules/react-plotly.js/factory.js
			...
			_createClass(PlotlyComponent, [
				{
					...
					value: function updatePlotly(shouldInvokeResizeHandler, figureCallbackFunction, shouldAttachUpdateEvents) {
						...
						this.p = this.p.then(function() {
							...
							if (!_this2.el) throw new Error("Missing element reference");
							...
							if (shouldAttachUpdateEvents) _this2.attachUpdateEvents();
						})["catch"](function(err) {
				...
				},
				{
					...
					value: function componentDidUpdate(prevProps) {
						...
						if (!figureChanged && (!revisionDefined || revisionDefined && !revisionChanged)) return;
					...
					value: function figureCallback(callback) {
						if (typeof callback === "function") {
							...
							callback({
								...
								frames: this.el._transitionData ? this.el._transitionData._frames : null
							}, this.el);
						}
					}
				},
				...
				},
				{
					...
					value: function getRef(el) {
						this.el = el;
						if (this.props.debug && isBrowser) window.gd = this.el;
					}
				},
				{
					...
					value: function syncEventHandlers() {
						...
						eventNames.forEach(function(eventName) {
							...
							if (prop && !hasHandler) _this6.addEventHandler(eventName, prop);
							else if (!prop && hasHandler) _this6.removeEventHandler(eventName);
...
//#endregion
//#region node_modules/react-plotly.js/react-plotly.js
var require_react_plotly = /* @__PURE__ */ __commonJSMin(((exports) => {
	Object.defineProperty(exports, "__esModule", { value: true });
	exports["default"] = void 0;
	var _factory = _interopRequireDefault(require_factory());
	var _plotly = _interopRequireDefault(require_plotly());
	function _interopRequireDefault(obj) {
		return obj && obj.__esModule ? obj : { "default": obj };
	}
	exports["default"] = (0, _factory["default"])(_plotly["default"]);
}));
//#endregion
export { require_react_plotly as t };
